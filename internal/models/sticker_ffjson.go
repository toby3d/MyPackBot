...
var ffjKeyStickerSavedAt = []byte("saved_at")
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 's':
					...
					} else if bytes.Equal(ffjKeyStickerSavedAt, kn) {
						currentKey = ffjtStickerSavedAt
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyStickerSavedAt, kn) {
					currentKey = ffjtStickerSavedAt
					state = fflib.FFParse_want_colon
					goto mainparse
				}
